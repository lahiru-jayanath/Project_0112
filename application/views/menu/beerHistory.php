                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group col-md-10" >
                                                        <select id="item" class="form-control"> 
                                                            ...
                                                            <option value='7' >Lion Beer </option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div id="bill_table" name="bill_table" class="portlet-body flip-scroll">
                                            <table class="table table-bordered table-striped table-condensed flip-content">
                                               ...
                                               // var_dump($bill_history);die;
                                                $n = 1;
                                                if (sizeof($beer_history)>0) {

                                                    foreach ($beer_history as $bill_history_result) {
                                                        ?>
                                                        <tr>
                                                            <td class="text-left"> <?php echo $n; ?> </td>
                                                            <td> <?php echo $bill_history_result->session_id; ?> </td>
                                                            <td class="numeric text-right"> <?php echo  $bill_history_result->liq_name; ?> </td>
        ...
        $("#filterX").click(function(e){
          ...
          $("#filter").click(function(e){ 
           e.preventDefault();
            ...
            var item = $("#item").val();
    if(st_date != "" && ed_date != ""){ //alert("asdsad");
  $.post("<?php echo base_url() ?>BeerHistory/load_data_from_date",
        {
          date_start : st_date,
          end_date : ed_date,
          item : item
