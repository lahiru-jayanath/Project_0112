                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <button type="button" class="btn blue" onclick="openModal('ADD',[]);" style="margin-bottom: 10px;">
                                        <i class="fa fa-birthday-cake"></i>  Add New Food </button>

                                    <!-- BEGIN SAMPLE TABLE PORTLET-->
                                    <div class="portlet box green">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-birthday-cake"></i>Foods Details </div>
                                            <div class="tools">
                                        ...
                                        <div class="portlet-body flip-scroll">
                                            <table class="table table-bordered table-striped table-condensed flip-content">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $n = 1;
                                                    if (sizeof($food_detail) > 0) {

                                                        foreach ($food_detail as $food_result) {
                                                            ?>
                                                            <tr>
                                                                <td class="text-left"> <?php echo $n; ?> </td>
                                                                <td> <?php echo $food_result->food_name; ?> </td>
                                                                <td class="numeric text-right"> <?php echo number_format((float) $food_result->food_price, 2, '.', ''); ?> </td>
                                                                <td class="numeric text-right"> <?php echo number_format((float) $food_result->food_discount, 2, '.', '') ?> </td>
                                                                <td class="numeric text-center"> <?php
                                                                    if ($food_result->publish == 1) {
                                                                        echo "Yes";
                                                                    } else {
                                                                        echo "No";
                                                                    }
                                                                ...
                                                                <td class="numeric text-center">
                                                                    <a class="btn btn-sm btn-success text-center" style="text-align:center;visibility:hidden;display:none"  title="Edit" href="<?php echo base_url() ?>Food/edit_foods?id=<?php echo $food_result->food_id; ?>" > <i class="fa fa-edit" style="margin-right: 10px;"></i> </a>
                                                                    <a class="btn btn-sm btn-danger text-center"  style="text-align:center;"  title="Delete" href="<?php echo base_url() ?>Food/delete_foods?id=<?php echo $food_result->food_id; ?>"  onclick="return confirm('Are You Sure?');"> <i class="fa fa-times" style="margin-right: 10px;"></i> </a>
                                                                    <button class="btn btn-sm btn-success text-center" id="<?php echo $food_result->food_id; ?>" onclick="editdata(this);"><i class="fa fa-edit" style="margin-right: 10px;"></i></button>
                                                                </td>
                                                            </tr>
                                                            <?php
                                                            $n++;
