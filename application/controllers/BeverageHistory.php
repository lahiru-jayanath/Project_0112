...
class BeverageHistory extends CI_Controller {
    ...
    public function index() {
       ...
       $item = array('0','31','32','33');
         $bill_history_details = $this->Bill_model->get_bill_history_details_from_beverage(date("Y-m-d"),$item);
      
        $bill_history = array(
            'beverage_history' => $bill_history_details
        );
       
        $this->load->view('template/header');
        $this->load->view('menu/berverageHistory',$bill_history);
    ...
    public function load_data_from_date(){
          ...
          $bill_history = $this->Bill_model->get_beverage_bill_history_detail_from_date($date_start,$date_end,$item);
       //   print_r($bill_history);
          $html  = '<table class="table table-bordered table-striped table-condensed flip-content">
               ...
               $n = 1;
                                        ...
                                        $html .=  '<td class="numeric text-right">'.$bill_history_result->drink_name .'</td>';
